...
static void lpm_run(LPM_Layout *layout, LPM_Packages *pkgs);
static uint8_t lpm_event_handler(struct tb_event *evt, LPM_Layout *layout, LPM_Packages *pkgs);
static void lpm_display(LPM_Layout *layout, LPM_Packages *pkgs);
